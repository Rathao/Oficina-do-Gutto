                ...
                <form action="../backend/oficina_controller.php?acao=nova_ordem" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="cliente_id" name="cliente_id" required>
                            ...
                            <?php foreach ($dados as $key): ?>
                                <option value="<?php echo $key->cliente_id; ?>"><?php echo htmlspecialchars($key->nome); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="veiculo_id" name="veiculo_id" required>
                            ...
                            <?php foreach ($dados as $key): ?>
                                <option value="<?php echo $key->veiculo_id; ?>">
                                    <?php echo htmlspecialchars($key->modelo); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
