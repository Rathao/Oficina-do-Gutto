            ...
            <div class="container mt-5">
                ...
                <form action="../backend/oficina_controller.php?acao=novo_agendamento" method="POST">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="cliente_id" name="cliente_id" required>
                            ...
                            <?php foreach ($clientes as $cliente): ?>
                                <option value="<?php echo $cliente->id; ?>"><?php echo htmlspecialchars($cliente->nome); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                        ...
                        <select class="form-control" id="veiculo_id" name="veiculo_id" required>
                            ...
                            <?php foreach ($veiculos as $veiculo): ?>
                                <option value="<?php echo $veiculo->id; ?>">
                                    <?php echo htmlspecialchars($veiculo->modelo); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="servico_solicitado" name="servico_solicitado"
                            rows="3"></textarea>
                    </div>
